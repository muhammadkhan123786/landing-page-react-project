...
const LeftComponent = () => {
  return (
    <>
      <Section>
        {/*left section */}
        <div className="flex gap-2 items-center bg-gray-50 w-fit px-4 py-2 rounded-full hover:bg-gray-100 cursor-pointer transition-colors group">
          <span className="group-hover:scale-110 transition-transform text-blue-600 group-hover:text-amber-500">
            <FaStar />
          </span>
          <span className="text-sm font-medium">Jump start your growth</span>
        </div>
        <h1 className="flex flex-col text-4xl md:text-5xl lg:text-5xl font-bold gap-1 leading-tight">
