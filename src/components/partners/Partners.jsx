...
const Partners = () => {
  ...
  return (
    <main className="w-full overflow-hidden container mx-auto py-20 flex sm:flex-row flex-col gap-4 sm:items-center items-start">
      <section className="w-[300px] shrink-0 text-gray-600 border-l-4 px-4 border-l-blue-500 bg-white py-2 z-10 sm:text-base text-lg font-semibold text-left">
        Proud partner at <br />
        Hubspot & Segment.
      </section>
